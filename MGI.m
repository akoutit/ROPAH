...
plot3(Xb,Yb,Zb,Xa,Ya,Za,X1,Y1,Z1,X2,Y2,Z2,X3,Y3,Z3,X4,Y4,Z4);
%figure;
%plot3(X,Y,Z,'.',Xs,Ys,Zs,Xb,Yb,Zb,Xa,Ya,Za,X1,Y1,Z1,X2,Y2,Z2,X3,Y3,Z3,X4,Y4,Z4);
